...
void stabCA(const string& randomCA_Rayquaza, double& stabCA_Rayquaza, double& effCA_Rayquaza, int& damageCA_Rayquaza,
...
public:
    ...
    ChargedMove() {
        ...
        static string MewtwoMoveTypeCA[10] = { "Flamethrower", "Ice Beam", "Thunderbolt", "Psychic",
            "Focus Blast", "Shadow Ball", "Hyper Beam", "Psystrike", "Frustration", "Return" };
